...
// DISABLED: This function is disabled because it depends on the format package
// which is not available. To re-enable, import "github.com/abbychau/mysql-parser/parser_driver/format"
//
